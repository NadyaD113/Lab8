...
let emp12 = new Designer("Oksana1", "Marchenko", 1000, 11, 0.8);
let emp11 = new Designer("Oksana2 ", "Marchenko", 1000, 11, 0.8);
let emp5 = new Developer("Oksana3 ", "Marchenko", 1000, 11);
let emp6 = new Developer("Oksana4 ", "Marchenko", 1000, 11);
let emp7 = new Developer("Oksana5 ", "Marchenko", 1000, 11);
let emp8 = new Designer("Oksana6 ", "Marchenko", 1000, 11, 0.8);
let emp9 = new Designer("Oksana7 ", "Marchenko", 1000, 11, 0.8);
let emp10 = new Developer("Oksana8 ", "Marchenko", 1000, 11);
let emp2 = new Developer("Viktor", "Medvedchuk", 1500, 5);
let emp4 = new Developer("Petro ", "Poroshenko", 1300, 6);
let emp13 = new Developer("Petro ", "Poroshenko", 1300, 6);
let emp3 = new Manager("Volodomyr", "Zelensky", 2000, 8, [emp13,emp11, emp2, emp4, emp10, emp9, emp8, emp7, emp6, emp5, emp12]);
